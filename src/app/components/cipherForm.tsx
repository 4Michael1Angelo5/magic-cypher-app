...
import styles from "../styles/encryptionForm.module.css"
...
export const CipherForm: React.FC<CipherFormProps> = (({
  ...
  const handleTransitionAfterImageUpload = (event:React.TransitionEvent) => {
    const isReadyForImageHash = encryptionInput.type === "image"
                              && uploadedImage 
                              && event.propertyName === "height"
                              && setLayoutReady
    if (isReadyForImageHash) {
      setLayoutReady(true);
    }
  }
  ...
  useEffect(() => {
    ...
    , [imageURL, uploadedImage, imgRef, encryptionInput.type])
  ...
  return (
    <form onSubmit={submitForm} ref={formRef}
      ...
      style={{
        ...
        position: "relative",
        transition: !isMobile ? "none" : "all .3s ease-in-out",
        transform: showModal ? "scale(1.03)" : "scale(1)",
      ...
      <div className={styles.encryptionInputContainer} //@TODO this css class name needs to be changed bc it is 
        onTransitionEnd = {handleTransitionAfterImageUpload}
        style={{
        ...
        }}>
        {
          ...
          <span className = {styles.imageInputPlaceHolderTxt}>
        ...
        }
        {
          ...
          encryptionInput.type === "image" && imageURL && (
            <img
              ...
              className = {styles.imageEncryptionInput} 
              />)
        }
        ...
        {/* Resize Icon Logic */}
        {
          ...
          <Image
            ...
            width={100}
            height={100}
            className={styles.resizeIconMobile} />
        }
        {
